...
public class IndiaSMS {
	...
	IndiaSMS(String username, String password) {
	...
	public static void sendIndiaSMS(String message) {
		// Replace DEMO_USERNAME with username of your account
		String username = "9810258737";
		// Replace DEMO_PASSWORD with password of your account
		String password = "qwer1234";
		// Replace TARGET_MOBILE with a valid mobile number
		//String toMobile = "9632875802";
		String toMobile = "9444037152";
		//String toMessage = "This is java test message";

		IndiaSMS fullOnSMS = new IndiaSMS(username, password);
		try {
			if (fullOnSMS.isLoggedIn()
					&& fullOnSMS.sendSMS(toMobile, message)) {
				fullOnSMS.logoutSMS();
				System.out.println("Message was sent successfully ");
			}
		} catch (IOException e) {
			System.out.println("Unable to send message, possible cause: "
					+ e.getMessage());
		}
	}
	...
	public static void main(String[] args) {
		...
		try {
			if (fullOnSMS.isLoggedIn()
					&& fullOnSMS.sendSMS(toMobile, toMessage)) {
				fullOnSMS.logoutSMS();
				System.out.println("Message was sent successfully ");
			}
		} catch (IOException e) {
